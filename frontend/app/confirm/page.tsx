  ...
  if (success) {
    return (
      <div className="rounded-lg border border-green-200 bg-green-50 p-6 text-center">
        <p className="mb-3 font-medium text-green-800">Email confirmed</p>
        <button
  ...
  return (
    <main className="flex min-h-0 flex-1 flex-col items-center justify-center overflow-y-auto px-6 py-16">
      <div className="w-full max-w-sm rounded-xl border border-gray-200 bg-white p-8 shadow-sm">
        <h1 className="mb-1 text-xl font-semibold text-gray-900">Confirm your email</h1>
        <p className="mb-6 text-sm text-gray-500">Enter the code we sent to your email address.</p>
